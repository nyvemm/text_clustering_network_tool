...
# Datasets
---------
For the experimental evaluations, we used 21 text collections from different domains, these datasets are available at: <https://github.com/ragero/text-collections/tree/master/Sequence_of_words_CSV>.
